...
export const devTenants: TenantWithDetails[] = [
  {
    id: 'tenant-1',
    type: 'Individual',
    profile_pic: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Ahmad',
  ...
  },
  {
    id: 'tenant-2',
    type: 'Individual',
    profile_pic: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Siti',
  ...
  },
  {
    id: 'tenant-4',
    type: 'Individual',
    profile_pic: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Maria',
    profile_thumb: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Maria',
    first_name: 'Maria',
    last_name: 'Garcia',
    identity_type: 'passport',
  ...
  },
  {
    id: 'tenant-5',
    type: 'Individual',
    profile_pic: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Raj',
